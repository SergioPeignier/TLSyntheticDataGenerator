...
htmlhelp_basename = 'TLSynDataGenedoc'
...
latex_documents = [
    (master_doc, 'TLSynDataGene.tex', 'TLSynDataGene Documentation',
     'Sergio Peignier, Mounir Atiq', 'manual'),
]
...
man_pages = [
    (master_doc, 'tlsyndatagene', 'TLSynDataGene Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'TLSynDataGene', 'TLSynDataGene Documentation',
     author, 'TLSynDataGene', 'One line description of project.',
     'Miscellaneous'),
]
